...
const ShopCategoryWomen = () => {
  ...
  useEffect(() => {
    ...
    dispatch(fetchProductLimitThunkAction({ start: 0, limit: displayedProducts, category: 'women' }));
  ...
  return (
    <div className="shop-category">
      ...
      <div role='button' className="shopcategory-loadmore" onClick={handleLoadMore}>
        Explore More
      </div>
    </div>
  );
